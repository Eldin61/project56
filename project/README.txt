Guide om Flask werkend te krijgen op je pc.

1. Git clone heel het project

2. Installeer met pip virtualenv ( pip install virtualenv)
 2.1 Windows users stop C:\Python27\Scripts in je PATH
